//middleware verifica que los dispositivos que entren esten dentro de la red de la empresa 
...
public class IpFilterMiddleware
{
    ...
    {
        // Obtener IP real (considera proxies como Render, nginx, etc.)
        var ip = ObtenerIpReal(context);

        // Siempre permitir loopback (para health checks de Render)
        ...
        // Verificar si la IP pertenece a algún prefijo permitido
        var permitida = _prefijosPermitidos.Any(prefijo => ipStr.StartsWith(prefijo));
    ...
    {
        // X-Forwarded-For puede venir con múltiples IPs separadas por coma
