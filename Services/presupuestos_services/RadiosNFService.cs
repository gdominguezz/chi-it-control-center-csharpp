...
{private readonly DbConnectionPool _pool;
    ...
    {await using var conn = await _pool.OpenAsync();
        ...
        {lista.Add(new
            {
                ID                  = reader.GetInt32(0)}, {ID_UNICO            = Str(reader}, {1)}, {OC                  = Str(reader}, {2)}, {FOLIO               = Str(reader}, {3)}, {FECHA_REGISTRO      = Str(reader}, {4)}, {RECIBIDO_POR        = Str(reader}, {5)}, {SUBCATEGORIA        = Str(reader}, {6)}, {MARCA               = Str(reader}, {7)}, {MODELO              = Str(reader}, {8)}, {NO_SERIE            = Str(reader}, {9)}, {CANTIDAD            = reader.IsDBNull(10) ? (int?)null     : reader.GetInt32(10)}, {OBSERVACIONES       = Str(reader}, {11)}, {PROVEEDOR           = Str(reader}, {12)}, {COSTO               = reader.IsDBNull(13) ? (decimal?)null : reader.GetDecimal(13)}, {MONEDA              = Str(reader}, {14)}, {VIDA_UTIL           = Str(reader}, {15)}, {REQUISITOR          = Str(reader}, {16)}, {DISPONIBLE          = reader.IsDBNull(17) ? (bool?)null    : reader.GetBoolean(17)}, {FECHA_SALIDA        = Str(reader}, {18)}, {ASIGNADO_A          = Str(reader}, {19)}, {DESTINO_PLANTA      = Str(reader}, {20)}, {PERSONAL_IT_ASIGNA  = Str(reader}, {21)});
        }
