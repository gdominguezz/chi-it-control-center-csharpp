...
public class AccesoriosNFService
{
    ...
    private static void AgregarParametros(SqlCommand cmd, AccesorioNFDto dto)
    {
    ...
    private async Task RegistrarHistorialAsync(SqlConnection conn, int accesorioId,
