...
public class PresupuestosReqVsOcService
{
    ...
    public (List<ReqVsOcRow> data, int total) GetAll(
        ...
        string? NO_REQUISICION = null, string? ORDEN_COMPRA = null,
        string? FECHA_COMPRA = null, string? PO_SUBTOTAL = null,
        string? MONEDA = null, string? OC_SUBTOTAL = null,
    ...
    public byte[] GenerarExcel(IEnumerable<ReqVsOcRow> rows)
    {
        ...
        string[] headers = { "No Requisicion","Orden Compra","Fecha Compra",
