...
public class DispositivosNFService
{
    ...
    public async Task<int> CrearAsync(DispositivoNFDto dto, string usuario)
    {
        ...
        Console.WriteLine("[DispositivosNF] RecalcularPorCambioEnHija Dispositivos NF " + dto.OC, dto.FOLIO);
        try { _ordenesService.RecalcularPorCambioEnHija("Dispositivos NF", dto.OC, dto.FOLIO); }
        catch (Exception ex) { Console.WriteLine("[DispositivosNF] ERROR RecalcularPorCambioEnHija: " + ex.Message); }
        return id;
    }
    ...
    public async Task<bool> EliminarAsync(int id)
    {
        ...
        if (deleted)
            Console.WriteLine("[DispositivosNF] RecalcularPorCambioEnHija Dispositivos NF " + ocVal, folioVal);
            try { _ordenesService.RecalcularPorCambioEnHija("Dispositivos NF", ocVal, folioVal); }
            catch (Exception ex) { Console.WriteLine("[DispositivosNF] ERROR RecalcularPorCambioEnHija: " + ex.Message); }
